...
cucumber_1.defineSupportCode(function ({ Given, When, Then, setDefaultTimeout }) {
    ...
    Given(/^Estou na página de Cadastro de Conteudo ao sistema$/, () => __awaiter(this, void 0, void 0, function* () {
    ...
    Given(/^So está contidos na lista de conteúdo o conteudo com titulo de "([^\"]*)" , descricao de "([^\"]*)" , introducao de "([^\"]*)" , desenvolvimento com titulo de "([^\"]*)" e descricao "([^\"]*)" e por fim, conclusao com "([^\"]*)"$/, (titulo, descriConteudo, intro, nomeTopico, descriTopico, concl) => __awaiter(this, void 0, void 0, function* () {
    ...
    When(/^Seleciono para remover o unico conteúdo da lista$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.$("a[name='remover']").click();
    }));
    Then(/^Um alerta deve ser exibida com a mensagem "([^\"]*)"$/, (alertMes) => __awaiter(this, void 0, void 0, function* () {
